...
3. **Don't address underperformance by increasing budget.** Budget showed no meaningful relationship with critic score (r=0.016) or audience score (r=0.218). A bigger budget on the next film is not a fix for a reception problem, the lever that matters is creative (script, casting, director), not just spend.
